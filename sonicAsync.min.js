...
function(c){var a=[].slice.call(arguments,1);return function(){var b=arguments.length,f;if(0<b){f=[].slice.call(arguments);for(var d=0;d<b;d++)a.push(f[d])}return c.apply(null,a)}};g.trace=0;g.silent=0})("object"===typeof module&&"object"===typeof exports?exports:this.sonicAsync=this.sonicAsync||{});
